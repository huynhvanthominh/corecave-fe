...
import hoaki from "../../assets/images/logo/hoaki.jpg";
                        ...
                        <div className="col-lg-3 col-md-12 col-12">
                            <div className="widget widget-logo">
                                <div className="logo-footer" id="logo-footer">
                                    <Link to="/">
                                        <img width='120px' className='logo-dark' id="logo_footer" src={hoaki} alt="nft-gaming" />
                                        <img className='logo-light' id="logo_footer" src={hoaki} alt="nft-gaming" />
