                    ...
                    <div className="flat-tabs tab-authors">
                        <div className="author-profile flex">
                            <div className="feature-profile">
                                <img src={currentProfile?.avatar || avatarFake} alt="Axies" className="avatar" />
                            </div>
                            <div className="infor-profile">
                                <span>Author Profile</span>
                                <h2 className="title">{currentProfile?.title}</h2>
                                                        ...
                                                        <div key={index} className="col-xl-3 col-lg-4 col-md-6 col-12">
                                                            <div className="sc-card-product explode ">
                                                                <div className="card-media">
                                                                    <Link to="/item-details-01"><img src={item?.nft?.image} alt="Axies" /></Link>
                                                                ...
                                                                <div className="card-title mg-bt-16">
                                                                    <h5><Link to="/item-details-01">"{item?.nft?.name}"</Link></h5>
                                                                </div>
                                                                <div className="meta-info">
                                                                    <div className="author">
                                                                        <div className="avatar">
                                                                            <img src={currentProfile?.avatar || avatarFake} alt="Axies" />
                                                                        </div>
                                                                        <div className="info">
                                                                            <span>Creator</span>
                                                                            <h6> <Link to="/author-02">{currentProfile.title}</Link> </h6>
                                                                        </div>
                                                                    </div>
